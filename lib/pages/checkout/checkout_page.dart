...
class _CheckoutPageState extends State<CheckoutPage> {
        ...
        body: SafeArea(
          child: BlocBuilder<StoreBloc, StoreState>(
            builder: (context, storeState) {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          // Assuming StoreBloc was initialized with location in HomePage
                          // If needed, dispatch FetchStoreEvent with last known location
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                  ...
                                  Column(
                                    ...
                                    children: state.coupons
                                        .where((coupon) =>
                                            ...
                                            !coupon.isDeleted)
                                        .map((coupon) =>
                                            _buildCouponOfferTile(coupon))
                                        .toList()
                                        .sublist(
                                          0,
                                          min(3, state.coupons.length),
                                        ),
                                  ),
                              ],
                            ),
                                      ...
                                      context.read<OrderBloc>().add(
                                            CreateOrderEvent(
                                              ...
                                              storeId: storeState
                                                  ...
                                                  .data
                                                  .store
                                                  .id, // Use storeId from StoreLoaded
              ...
              return const Center(child: Text('Unknown store state'));
            },
          ),
        ),
      ),
  ...
  Widget _buildCouponOfferTile(Coupon coupon) {
    ...
    return Padding(
      ...
      child: ListTile(
        enabled: !coupon.usedUsers.contains(userId),
        title: Text(
          coupon.couponCode,
